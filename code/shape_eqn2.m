...
function dydx = shape_eqn2(x,y,params)
% y(1) = z, y(2) = r, y(3) = phi, y(4) = phi', y(5) = phi'', y(6) = smax
% params(1) = kappa, params(2) = delta_p; params(3) = gamma;
...
dydx =  [ -sin(y(3)) * y(6);
          ...
          + y(4)*(y(6))^2*params(3)/params(1) + params(3)/params(1)/y(2)*sin(y(3))*(y(6))^3 ...
          - ((cos(y(3)))^2+1)/2/(y(2))^3*sin(y(3))*y(6)^3 ...
          - params(2)/params(1)*y(6)^3;
          0+x-x ];
end
